...
//        System.out.println(request);
        String info = "";
        String msg = "071800F1" + add + "01" + request;//要发送的命令
        info = "02" + msg + ByteUtils.checkcode(msg);
//        System.out.println("info="+info+"  字符串：" + ByteUtils.hexStr2Bytes(info));
    ...
    public void openSerialPort() {
        ...
        if (commName == null || commName.equals("")) {
            ...
            try {
                mSerialport = openPort("/dev/ttyUSB0", 115200);
...
//                        System.out.println("========================================");
                        ...
                        l = Integer.parseInt(handler[handler.length - 2] + handler[handler.length - 3], 16);
                        sensor.put("ILLU", s);
                        dataAll.put(s, t);
//                        System.out.println("长度"+data.length);
//                        System.out.println("内容"+ByteUtils.dispose(data,data.length));
...
//                        System.out.println("========================================");
    ...
    public static void main(String[] args) {
        SensorPortUtils serialPort = new SensorPortUtils();
